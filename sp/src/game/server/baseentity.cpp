...
BEGIN_ENT_SCRIPTDESC_ROOT( CBaseEntity, "Root class of all server-side entities" )
	...
	DEFINE_SCRIPTFUNC_NAMED( ScriptIsRareEnemy, "IsRareEnemy", "(FR) Are we a 'rare enemy'?" )
	DEFINE_SCRIPTFUNC_NAMED( ScriptSetRareEnemy, "SetRareEnemy", "(FR) Make us a 'rare enemy'" )

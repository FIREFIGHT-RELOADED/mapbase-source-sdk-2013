...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	//custom enums
	ADD_DEF_SCHEDULE( "SCHED_PATROL_WALK_LOOP",						SCHED_PATROL_WALK_LOOP);
}
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_PATROL_WALK_LOOP );
...
(
	...
	"		TASK_WAIT						3"
	"		TASK_WAIT_RANDOM				3"
	"		TASK_SET_SCHEDULE				SCHEDULE:SCHED_PATROL_WALK_LOOP"
	""
	"	Interrupts"
	"		COND_CAN_RANGE_ATTACK1 "
	"		COND_CAN_RANGE_ATTACK2 "

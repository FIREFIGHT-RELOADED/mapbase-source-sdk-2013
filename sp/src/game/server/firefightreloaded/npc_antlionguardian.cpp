...
ConVar	g_debug_antlionguardian( "g_debug_antlionguardian", "0" );
ConVar	sk_antlionguardian_dmg_charge( "sk_antlionguardian_dmg_charge", "0" );
ConVar	sk_antlionguardian_dmg_shove( "sk_antlionguardian_dmg_shove", "0" );
// When enabled, add code to have the antlion bleed profusely as it is badly injured.
#define ANTLIONGUARD_BLOOD_EFFECTS 2
ConVar	g_antlionguardian_hemorrhage( "g_antlionguardian_hemorrhage", "1", FCVAR_NONE, "If 1, guard will emit a bleeding particle effect when wounded." );
...
#define	ANTLIONGUARD_MODEL		"models/gntlion_guard.mdl"
...
enum
{
	SCHED_ANTLIONGUARDIAN_CHARGE = LAST_SHARED_SCHEDULE,
	SCHED_ANTLIONGUARDIAN_CHARGE_CRASH,
	SCHED_ANTLIONGUARDIAN_CHARGE_CANCEL,
	SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK,
	SCHED_ANTLIONGUARDIAN_PHYSICS_DAMAGE_HEAVY,
	SCHED_ANTLIONGUARDIAN_UNBURROW,
	SCHED_ANTLIONGUARDIAN_CHARGE_TARGET,
	SCHED_ANTLIONGUARDIAN_FIND_CHARGE_POSITION,
	SCHED_ANTLIONGUARDIAN_MELEE_ATTACK1,
	SCHED_ANTLIONGUARDIAN_SUMMON,
	SCHED_ANTLIONGUARDIAN_PATROL_RUN,
	SCHED_ANTLIONGUARDIAN_ROAR,
	SCHED_ANTLIONGUARDIAN_CHASE_ENEMY_TOLERANCE,
	SCHED_FORCE_ANTLIONGUARDIAN_PHYSICS_ATTACK,
	SCHED_ANTLIONGUARDIAN_CANT_ATTACK,
	SCHED_ANTLIONGUARDIAN_TAKE_COVER_FROM_ENEMY,
	SCHED_ANTLIONGUARDIAN_CHASE_ENEMY
};
...
enum
{
	TASK_ANTLIONGUARDIAN_CHARGE = LAST_SHARED_TASK,
	TASK_ANTLIONGUARDIAN_GET_PATH_TO_PHYSOBJECT,
	TASK_ANTLIONGUARDIAN_SHOVE_PHYSOBJECT,
	TASK_ANTLIONGUARDIAN_SUMMON,
	TASK_ANTLIONGUARDIAN_SET_FLINCH_ACTIVITY,
	TASK_ANTLIONGUARDIAN_GET_PATH_TO_CHARGE_POSITION,
	TASK_ANTLIONGUARDIAN_GET_PATH_TO_NEAREST_NODE,
	TASK_ANTLIONGUARDIAN_GET_CHASE_PATH_ENEMY_TOLERANCE,
	TASK_ANTLIONGUARDIAN_OPPORTUNITY_THROW,
	TASK_ANTLIONGUARDIAN_FIND_PHYSOBJECT,
};
...
enum
{
	COND_ANTLIONGUARDIAN_PHYSICS_TARGET = LAST_SHARED_CONDITION,
	COND_ANTLIONGUARDIAN_PHYSICS_TARGET_INVALID,
	COND_ANTLIONGUARDIAN_HAS_CHARGE_TARGET,
	COND_ANTLIONGUARDIAN_CAN_SUMMON,
	COND_ANTLIONGUARDIAN_CAN_CHARGE
};

enum
{	
	SQUAD_SLOT_ANTLIONGUARDIAN_CHARGE = LAST_SHARED_SQUADSLOT,
};
...
Activity ACT_GNTLIONGUARD_SEARCH;
Activity ACT_GNTLIONGUARD_PEEK_FLINCH;
Activity ACT_GNTLIONGUARD_PEEK_ENTER;
Activity ACT_GNTLIONGUARD_PEEK_EXIT;
Activity ACT_GNTLIONGUARD_PEEK1;
Activity ACT_GNTLIONGUARD_BARK;
Activity ACT_GNTLIONGUARD_PEEK_SIGHTED;
Activity ACT_GNTLIONGUARD_SHOVE_PHYSOBJECT;
Activity ACT_GNTLIONGUARD_FLINCH_LIGHT;
Activity ACT_GNTLIONGUARD_UNBURROW;
Activity ACT_GNTLIONGUARD_ROAR;
Activity ACT_GNTLIONGUARD_RUN_HURT;

// Flinches
Activity ACT_GNTLIONGUARD_PHYSHIT_FR;
Activity ACT_GNTLIONGUARD_PHYSHIT_FL;
Activity ACT_GNTLIONGUARD_PHYSHIT_RR;
Activity ACT_GNTLIONGUARD_PHYSHIT_RL;

// Charge
Activity ACT_GNTLIONGUARD_CHARGE_START;
Activity ACT_GNTLIONGUARD_CHARGE_CANCEL;
Activity ACT_GNTLIONGUARD_CHARGE_RUN;
Activity ACT_GNTLIONGUARD_CHARGE_CRASH;
Activity ACT_GNTLIONGUARD_CHARGE_STOP;
...
int AE_GNTLIONGUARD_SHOVE;
int AE_GNTLIONGUARD_FOOTSTEP_LIGHT;
int AE_GNTLIONGUARD_FOOTSTEP_HEAVY;
int AE_GNTLIONGUARD_CHARGE_EARLYOUT;
int AE_GNTLIONGUARD_VOICE_GROWL;
int AE_GNTLIONGUARD_VOICE_BARK;
int AE_GNTLIONGUARD_VOICE_PAIN;
int AE_GNTLIONGUARD_VOICE_SQUEEZE;
int AE_GNTLIONGUARD_VOICE_SCRATCH;
int AE_GNTLIONGUARD_VOICE_GRUNT;
int AE_GNTLIONGUARD_VOICE_ROAR;
int AE_GNTLIONGUARD_BURROW_OUT;
...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_AntlionGuardian : public CAI_BlendedNPC
{
public:
	DECLARE_CLASS( CNPC_AntlionGuardian, CAI_BlendedNPC );
	DECLARE_SERVERCLASS();
	DECLARE_DATADESC();

	CNPC_AntlionGuardian( void );
	...
	//---------------------------------
	class CNavigator : public CAI_ComponentWithOuter<CNPC_AntlionGuardian, CAI_Navigator>
	{
		typedef CAI_ComponentWithOuter<CNPC_AntlionGuardian, CAI_Navigator> BaseClass;
	public:
		CNavigator( CNPC_AntlionGuardian *pOuter )
			:	BaseClass( pOuter )
		{
		}
...
//==================================================
// CNPC_AntlionGuardian::m_DataDesc
//==================================================

BEGIN_DATADESC( CNPC_AntlionGuardian )
...
envelopePoint_t envAntlionGuardianFastGrowl[] =
{
	{	1.0f, 1.0f,
		0.2f, 0.4f,
	},
...
//Bark 1 (Growl High)
envelopePoint_t envAntlionGuardianBark1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Bark 2 (Confused)
envelopePoint_t envAntlionGuardianBark2[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Pain
envelopePoint_t envAntlionGuardianPain1[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Squeeze (High Growl)
envelopePoint_t envAntlionGuardianSqueeze[] =
{
	{	1.0f, 1.0f,
		0.1f, 0.2f,
	},
...
//Scratch (Low Growl)
envelopePoint_t envAntlionGuardianScratch[] =
{
	{	1.0f, 1.0f,
		0.4f, 0.6f,
	},
...
//Grunt
envelopePoint_t envAntlionGuardianGrunt[] =
{
	{	0.6f, 1.0f,
		0.1f, 0.2f,
	},
...
envelopePoint_t envAntlionGuardianGrunt2[] =
{
	{	0.2f, 0.4f,
		0.1f, 0.2f,
	},
...
//==============================================================================================
static impactentry_t antlionGuardianLinearTable[] =
{
	{ 100*100,	10 },
	{ 250*250,	25 },
	{ 350*350,	50 },
...
static impactentry_t antlionGuardianAngularTable[] =
{
	{  50* 50, 10 },
	{ 100*100, 25 },
	{ 150*150, 50 },
...
impactdamagetable_t gAntlionGuardianImpactDamageTable =
{
	antlionGuardianLinearTable,
	antlionGuardianAngularTable,
	
	ARRAYSIZE(antlionGuardianLinearTable),
	ARRAYSIZE(antlionGuardianAngularTable),
...
//-----------------------------------------------------------------------------
const impactdamagetable_t &CNPC_AntlionGuardian::GetPhysicsImpactDamageTable( void )
{
	return gAntlionGuardianImpactDamageTable;
}

//==================================================
// CNPC_AntlionGuardian
//==================================================

CNPC_AntlionGuardian::CNPC_AntlionGuardian( void )
{
	m_bInCavern = false;
...
LINK_ENTITY_TO_CLASS( npc_antlionguardian, CNPC_AntlionGuardian );

IMPLEMENT_SERVERCLASS_ST(CNPC_AntlionGuardian, DT_NPC_AntlionGuardian)
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::UpdateOnRemove( void )
{
	DestroyGlows();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Precache( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::DestroyGlows( void )
{
	if ( m_hCaveGlow[0] )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::CreateGlow( CSprite **pSprite, const char *pAttachName )
{
	if ( pSprite == NULL )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Spawn( void )
{
	Precache();
	...
	m_iHealth = sk_antlionguardian_health.GetFloat();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Activate( void )
{
	BaseClass::Activate();
	...
	while ( ( pObject = gEntList.FindEntityInSphere( pObject, WorldSpaceCenter(), 2500 ) ) != NULL )
	{
		...
		if ( g_debug_antlionguardian.GetInt() == 5 )
		{
			Msg("Antlion Guardian: Added prop with model '%s' to sense list.\n", STRING(pObject->GetModelName()) );
...
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::CanSummon( bool bIgnoreTime )
{
	if ( !m_bBarkEnabled )
		return false;
...
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::SelectUnreachableSchedule( void )
{
	// If we're in the cavern setting, we opt out of this
	if ( m_bInCavern )
		return SCHED_ANTLIONGUARDIAN_CHASE_ENEMY_TOLERANCE;
	// Summon antlions if we can
	if ( HasCondition( COND_ANTLIONGUARDIAN_CAN_SUMMON ) )
		return SCHED_ANTLIONGUARDIAN_SUMMON;
	...
	if ( pTarget )
	{
		...
		SetCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET );
	...
	if ( HasCondition( COND_SEE_ENEMY ) )
	{
		...
		if ( m_flNextRoarTime < gpGlobals->curtime )
		{
			...
			return SCHED_ANTLIONGUARDIAN_ROAR;
		}
		...
		if ( GetEnemy() && HasCondition( COND_HEAVY_DAMAGE ) )
		{
			...
			return SCHED_ANTLIONGUARDIAN_TAKE_COVER_FROM_ENEMY;
		}
	}
	...
	return SCHED_ANTLIONGUARDIAN_CANT_ATTACK;
}

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::SelectCombatSchedule( void )
{
	ClearHintGroup();
	...
	*/
	...
	if ( HasCondition(COND_ANTLIONGUARDIAN_CAN_SUMMON) )
	{
		...
		if ( HasCondition( COND_ANTLIONGUARDIAN_CAN_CHARGE ) && m_iNumLiveAntlions )
			return SCHED_ANTLIONGUARDIAN_CHARGE;
	...
	//Physics target
	if ( HasCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET ) && !m_bInCavern )
		return SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK;
	...
	// Charging
	if ( HasCondition( COND_ANTLIONGUARDIAN_CAN_CHARGE ) )
	{
		// Don't let other squad members charge while we're doing it
		OccupyStrategySlot( SQUAD_SLOT_ANTLIONGUARDIAN_CHARGE );
		return SCHED_ANTLIONGUARDIAN_CHARGE;
	}
...
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::ShouldCharge( const Vector &startPos, const Vector &endPos, bool useTime, bool bCheckForCancel )
{
	...
	if ( IsStrategySlotRangeOccupied( SQUAD_SLOT_ANTLIONGUARDIAN_CHARGE, SQUAD_SLOT_ANTLIONGUARDIAN_CHARGE ) )
		return false;
	...
	// Draw the probe
	if (g_debug_antlionguardian.GetInt() == 1)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::SelectSchedule( void )
{
	...
	if ( 0 ) //g_debug_antlionguardian.GetInt() == 3 )
	{
		m_flPhysicsCheckTime = 0;
	...
	if ( !m_bInCavern && HasCondition( COND_HEAVY_DAMAGE ) && m_flNextHeavyFlinchTime < gpGlobals->curtime )
	{
		...
		return SCHED_ANTLIONGUARDIAN_PHYSICS_DAMAGE_HEAVY;
	}
	...
	if ( m_bPreferPhysicsAttack )
	{
		...
		if ( HasCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET ) )
			return SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK;
	}
	...
	{
		ClearCondition( COND_ANTLIONGUARDIAN_HAS_CHARGE_TARGET );
		ClearHintGroup();
		...
		else
		{
			...
			if ( ShouldCharge( GetAbsOrigin(), GetEnemy()->GetAbsOrigin(), false, false ) == false )
				return SCHED_ANTLIONGUARDIAN_FIND_CHARGE_POSITION;

			return SCHED_ANTLIONGUARDIAN_CHARGE_TARGET;
		}
	}
	...
	{
		//return SCHED_ANTLIONGUARDIAN_PATROL_RUN;
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::MeleeAttack1Conditions( float flDot, float flDist )
{
	...
	if ( IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHARGE ) )
		return 0;
...
// Purpose: 
//-----------------------------------------------------------------------------
float CNPC_AntlionGuardian::MaxYawSpeed( void )
{
	Activity eActivity = GetActivity();

	// Stay still
	if (( eActivity == ACT_GNTLIONGUARD_SEARCH ) || 
		( eActivity == ACT_GNTLIONGUARD_PEEK_ENTER ) || 
		( eActivity == ACT_GNTLIONGUARD_PEEK_EXIT ) || 
		( eActivity == ACT_GNTLIONGUARD_PEEK1 ) || 
		( eActivity == ACT_GNTLIONGUARD_BARK ) || 
		( eActivity == ACT_GNTLIONGUARD_PEEK_SIGHTED ) || 
	...
	if ( eActivity == ACT_GNTLIONGUARD_CHARGE_START )
		return 4.0f;

	if ( m_bInCavern )
	{
		// Allow a better turning rate when moving quickly but not charging the player
		if ( ( eActivity == ACT_GNTLIONGUARD_CHARGE_RUN ) && IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHARGE ) == false )
			return 16.0f;
	}

	// Turn more slowly as we close in on our target
	if ( eActivity == ACT_GNTLIONGUARD_CHARGE_RUN )
	{
		if ( pEnemy == NULL )
			return 2.0f;
	...
	if ( eActivity == ACT_GNTLIONGUARD_CHARGE_STOP )
		return 8.0f;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::OverrideMove( float flInterval )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Shove( void )
{
	if ( GetNextAttack() > gpGlobals->curtime )
		return;
	...
	float damage = ( pTarget->IsPlayer() ) ? sk_antlionguardian_dmg_shove.GetFloat() : 250;
	...
	if ( pHurt )
	{
		...
		if ( pHurt->IsPlayer() )
		{
			...
			if ( pHurt->IsPlayer() && pHurt->IsAlive() && pHurt->m_iHealth > ANTLIONGUARD_POISON_TO)
			{
...
public:
	...
	CTraceFilterCharge( const IHandleEntity *passentity, int collisionGroup, CNPC_AntlionGuardian *pAttacker )
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( pEntity )
		{
			...
			float	flDamage = ( pEntity->IsPlayer() ) ? sk_antlionguardian_dmg_shove.GetFloat() : 250;;
...
public:
	...
	CNPC_AntlionGuardian	*m_pAttacker;
};
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Footstep( bool bHeavy )
{
...
//			*pOut - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::GetPhysicsShoveDir( CBaseEntity *pObject, float flMass, Vector *pOut )
{
...
// Input  : *pEvent - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::HandleAnimEvent( animevent_t *pEvent )
{
	if ( pEvent->event == AE_GNTLIONGUARD_CHARGE_EARLYOUT )
	{
		...
		{
			SetSchedule( SCHED_ANTLIONGUARDIAN_CHARGE_CANCEL );
		}
		*/
	...
	if ( pEvent->event == AE_GNTLIONGUARD_SHOVE_PHYSOBJECT )
	{
		if ( m_hPhysicsTarget == NULL )
		{
		...
		ClearCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET );
		ClearCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET_INVALID );
	...
	if ( pEvent->event == AE_GNTLIONGUARD_CHARGE_HIT )
	{
	...
	if ( pEvent->event == AE_GNTLIONGUARD_SHOVE )
	{
	...
	if ( pEvent->event == AE_GNTLIONGUARD_FOOTSTEP_LIGHT )
	{
		if ( HasSpawnFlags(SF_ANTLIONGUARD_INSIDE_FOOTSTEPS) )
		{
			Footstep(false);
	...
	if ( pEvent->event == AE_GNTLIONGUARD_FOOTSTEP_HEAVY )
	{
		if ( HasSpawnFlags(SF_ANTLIONGUARD_INSIDE_FOOTSTEPS) )
		{
			Footstep(true);
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_GROWL )
	{
		StartSounds();
		...
		{
			duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianFastGrowl, ARRAYSIZE(envAntlionGuardianFastGrowl) );
		}
		else
		{
			duration = 1.0f;
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_BARK )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianBark1, ARRAYSIZE(envAntlionGuardianBark1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianBark2, ARRAYSIZE(envAntlionGuardianBark2) );
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_ROAR )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianFastGrowl, ARRAYSIZE(envAntlionGuardianFastGrowl) );
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_PAIN )
	{
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianPain1, ARRAYSIZE(envAntlionGuardianPain1) );
		ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianBark2, ARRAYSIZE(envAntlionGuardianBark2) );
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_SQUEEZE )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope( m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianSqueeze, ARRAYSIZE(envAntlionGuardianSqueeze) );
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_SCRATCH )
	{	
		StartSounds();
	...
	if ( pEvent->event == AE_GNTLIONGUARD_VOICE_GRUNT )
	{	
		StartSounds();

		float duration = ENVELOPE_CONTROLLER.SoundPlayEnvelope(m_pConfusedSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianGrunt, ARRAYSIZE(envAntlionGuardianGrunt));
		ENVELOPE_CONTROLLER.SoundPlayEnvelope(m_pGrowlHighSound, SOUNDCTRL_CHANGE_VOLUME, envAntlionGuardianGrunt2, ARRAYSIZE(envAntlionGuardianGrunt2));
	...
	if ( pEvent->event == AE_GNTLIONGUARD_BURROW_OUT )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::SetHeavyDamageAnim( const Vector &vecSource )
{
	if ( !m_bInCavern )
	{
		...
		if ( damageDot > 0.0f )
		{
			...
			{
				m_nFlinchActivity = ACT_GNTLIONGUARD_PHYSHIT_FR;
			}
			else
			{
				m_nFlinchActivity = ACT_GNTLIONGUARD_PHYSHIT_FL;
			}
		}
		else
		{
			...
			if ( damageRightDot < 0.0f )
			{
				m_nFlinchActivity = ACT_GNTLIONGUARD_PHYSHIT_RR;
			}
			else
			{
				m_nFlinchActivity = ACT_GNTLIONGUARD_PHYSHIT_RL;
			}
		}
	}
}
...
// Input  : &info - 
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::OnTakeDamage_Alive( const CTakeDamageInfo &info )
{
...
//			bitsDamageType - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::TraceAttack( const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator )
{
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::StartTask( const Task_t *pTask )
{
	switch ( pTask->iTask )
	{
	case TASK_ANTLIONGUARDIAN_SET_FLINCH_ACTIVITY:
		SetIdealActivity( (Activity) m_nFlinchActivity );
		break;

	case TASK_ANTLIONGUARDIAN_SUMMON:
		SummonAntlions();
		m_OnSummon.FireOutput( this, this, 0 );
		TaskComplete();
		break;

	case TASK_ANTLIONGUARDIAN_SHOVE_PHYSOBJECT:
		{
			...
			SetActivity( ACT_GNTLIONGUARD_SHOVE_PHYSOBJECT );
		}
		break;

	case TASK_ANTLIONGUARDIAN_FIND_PHYSOBJECT:
		{
	...
	case TASK_ANTLIONGUARDIAN_GET_PATH_TO_PHYSOBJECT:
		{
			if ( ( m_hPhysicsTarget == NULL ) || ( GetEnemy() == NULL ) )
			{
	...
	case TASK_ANTLIONGUARDIAN_CHARGE:
		{
			// HACK: Because the guard stops running his normal blended movement 
			//		 here, he also needs to remove his blended movement layers!
			GetMotor()->MoveStop();

			SetActivity( ACT_GNTLIONGUARD_CHARGE_START );
			m_bDecidedNotToStop = false;
		}
		break;


	case TASK_ANTLIONGUARDIAN_GET_PATH_TO_CHARGE_POSITION:
		{
	...
	case TASK_ANTLIONGUARDIAN_GET_PATH_TO_NEAREST_NODE:
		{
			if ( !GetEnemy() )
			{
	...
	case TASK_ANTLIONGUARDIAN_GET_CHASE_PATH_ENEMY_TOLERANCE:
		{
	...
	case TASK_ANTLIONGUARDIAN_OPPORTUNITY_THROW:
		{
			...
			if ( m_iNumLiveAntlions >= 2 && RandomFloat(0,1) > 0.5 )
			{
				...
				if ( HasCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET ) && !m_bInCavern )
				{
					SetSchedule( SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK );
				}
			}
...
//-----------------------------------------------------------------------------
void GuardianApplyChargeDamage( CBaseEntity *pAntlionGuard, CBaseEntity *pTarget, float flDamage )
{
	...
	// If I am a cavern guard attacking the player, and he still lives, then poison him too.
	Assert( dynamic_cast<CNPC_AntlionGuardian *>(pAntlionGuard) );

	if (pTarget->IsPlayer() && pTarget->IsAlive() && pTarget->m_iHealth > ANTLIONGUARD_POISON_TO)
	{
		// That didn't finish them. Take them down to one point with poison damage. It'll heal.
...
//-----------------------------------------------------------------------------
class CGuardianTraceFilterSkipPhysics : public CTraceFilter
{
public:
	// It does have a base, but we'll never network anything below here..
	DECLARE_CLASS_NOBASE(CGuardianTraceFilterSkipPhysics);
	
	CGuardianTraceFilterSkipPhysics(const IHandleEntity *passentity, int collisionGroup, float minMass)
	...
	virtual bool ShouldHitEntity( IHandleEntity *pHandleEntity, int contentsMask )
	{
		...
		if ( pEntity )
		{
			...
			if (pEntity->Classify() == CLASS_ANTLION && g_pGameRules->IsSkillLevel(SKILL_EASY))
			{
				...
				GuardianApplyChargeDamage(pGuard, pEntity, pEntity->GetHealth());
				return false;
			}
		}
					 ...
					 int collisionGroup, trace_t *ptr, float minMass )
{
	...
	CGuardianTraceFilterSkipPhysics traceFilter(ignore, collisionGroup, minMass);
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::EnemyIsRightInFrontOfMe( CBaseEntity **pEntity )
{
	if ( !GetEnemy() )
		return false;
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::ChargeLookAhead( void )
{
	trace_t	tr;
	Vector vecForward;
	...
	if ( tr.fraction != 1.0 )
	{
		...
		AddGesture( ACT_GNTLIONGUARD_CHARGE_ANTICIPATION );
	}
}
...
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::HandleChargeImpact( Vector vecImpact, CBaseEntity *pEntity )
{
...
#endif
	{
		...
		if ( !IsPlayingGesture( ACT_GNTLIONGUARD_CHARGE_HIT ) )
		{
			RestartGesture( ACT_GNTLIONGUARD_CHARGE_HIT );
		}
		...
		SetActivity( ACT_GNTLIONGUARD_CHARGE_STOP );
...
// Output : float
//-----------------------------------------------------------------------------
float CNPC_AntlionGuardian::ChargeSteer( void )
{
	trace_t	tr;
...
// Input  : *pTask - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::RunTask( const Task_t *pTask )
{
	switch (pTask->iTask)
	{
	case TASK_ANTLIONGUARDIAN_SET_FLINCH_ACTIVITY:
	...
	case TASK_ANTLIONGUARDIAN_CHARGE:
		{
			...
			if ( eActivity == ACT_GNTLIONGUARD_CHARGE_STOP || eActivity == ACT_GNTLIONGUARD_CHARGE_CRASH ) 
			{
				if ( IsActivityFinished() )
				{
					TaskComplete();
			...
			if ( ( eActivity == ACT_GNTLIONGUARD_CHARGE_START ) && ( IsActivityFinished() ) )
			{
				SetActivity( ACT_GNTLIONGUARD_CHARGE_RUN );
			}

			// See if we're still running
			if ( eActivity == ACT_GNTLIONGUARD_CHARGE_RUN || eActivity == ACT_GNTLIONGUARD_CHARGE_START ) 
			{
			...
			if ( AutoMovement( GetEnemy(), &moveTrace ) == false )
			{
				...
				if ( HandleChargeImpact( moveTrace.vEndPosition, moveTrace.pObstruction ) )
				{
					...
					if ( eActivity != ACT_GNTLIONGUARD_CHARGE_STOP )
					{
						...
						{
							SetActivity( ACT_GNTLIONGUARD_CHARGE_CRASH );
						}
					}
				}
				else if ( moveTrace.pObstruction )
				{
					// If we hit an antlion, don't stop, but kill iton easy
					if ( moveTrace.pObstruction->Classify() == CLASS_ANTLION )
					{
						...
						else
						{
							...
							{
								GuardianApplyChargeDamage(this, moveTrace.pObstruction, moveTrace.pObstruction->GetHealth());
							}
						}
					}
				}
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::SummonAntlions( void )
{
	...
	for ( int i = 0; (m_iNumLiveAntlions < ANTLIONGUARD_SUMMON_COUNT) && (iSpawnPoint < ARRAYSIZE(sAntlionSpawnPositions)); i++ )
	{
		...
		{
			if (g_debug_antlionguardian.GetInt() == 2)
			{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::FoundEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::LostEnemy( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputSetShoveTarget( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputSetChargeTarget( inputdata_t &inputdata )
{
	if ( !IsAlive() )
		return;
	...
	SetCondition( COND_ANTLIONGUARDIAN_HAS_CHARGE_TARGET );
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputClearChargeTarget( inputdata_t &inputdata )
{
	m_hChargeTarget = NULL;
}
...
Activity CNPC_AntlionGuardian::NPC_TranslateActivity( Activity baseAct )
{
	...
	if ( ( baseAct == ACT_RUN ) && ( m_iHealth <= (m_iMaxHealth/4) ) )
		return (Activity) ACT_GNTLIONGUARD_RUN_HURT;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::ShouldWatchEnemy( void )
{
	Activity nActivity = GetActivity();

	if ( ( nActivity == ACT_GNTLIONGUARD_SEARCH ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PEEK_ENTER ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PEEK_EXIT ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PEEK1 ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PEEK_SIGHTED ) || 
		 ( nActivity == ACT_GNTLIONGUARD_SHOVE_PHYSOBJECT ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PHYSHIT_FR ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PHYSHIT_FL ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PHYSHIT_RR ) || 
		 ( nActivity == ACT_GNTLIONGUARD_PHYSHIT_RL ) || 
		 ( nActivity == ACT_GNTLIONGUARD_CHARGE_CRASH ) || 
		 ( nActivity == ACT_GNTLIONGUARD_CHARGE_HIT ) ||
		 ( nActivity == ACT_GNTLIONGUARD_CHARGE_ANTICIPATION ) )
	{
		return false;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::UpdateHead( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::MaintainPhysicsTarget( void )
{
	if ( m_hPhysicsTarget == NULL || GetEnemy() == NULL )
		return;
	...
	{
		ClearCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET );
		SetCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET_INVALID );
		m_hPhysicsTarget = NULL;
		return;
	}
	else
	...
	if (g_debug_antlionguardian.GetInt() == 3)
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::UpdatePhysicsTarget( bool bPreferObjectsAlongTargetVector, float flRadius )
{
	if ( GetEnemy() == NULL )
		return;
...
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::ShouldProbeCollideAgainstEntity( CBaseEntity *pEntity )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::PrescheduleThink( void )
{
	...
	if ( IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHASE_ENEMY ) || 
		 IsCurSchedule( SCHED_ANTLIONGUARDIAN_PATROL_RUN ) ||
		 IsCurSchedule( SCHED_ANTLIONGUARDIAN_CANT_ATTACK ) ||
		 IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHASE_ENEMY_TOLERANCE ) )
	{
		bool bCheckAlongLine = ( IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHASE_ENEMY ) || IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHASE_ENEMY_TOLERANCE ) );
		UpdatePhysicsTarget( bCheckAlongLine );
	}
	else if ( !IsCurSchedule( SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK ) )
	{
		ClearCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET );
		m_hPhysicsTarget = NULL;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::GatherConditions( void )
{
	BaseClass::GatherConditions();

	if ( CanSummon(false) )
	{
		SetCondition( COND_ANTLIONGUARDIAN_CAN_SUMMON );
	}
	else
	{
		ClearCondition( COND_ANTLIONGUARDIAN_CAN_SUMMON );
	}

	// Make sure our physics target is still valid
	MaintainPhysicsTarget();

	if( IsCurSchedule(SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK) )
	{
	...
	if ( GetEnemy() )
	{
		...
		{
			SetCondition( COND_ANTLIONGUARDIAN_CAN_CHARGE );
		}
		else
		{
			ClearCondition( COND_ANTLIONGUARDIAN_CAN_CHARGE );
		}
	}
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::StopLoopingSounds()
{
	//Stop all sounds
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputUnburrow( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
	...
	SetSchedule( SCHED_ANTLIONGUARDIAN_UNBURROW );
...
// Output  :
//------------------------------------------------------------------------------
bool CNPC_AntlionGuardian::IsUnreachable(CBaseEntity *pEntity)
{
...
//-----------------------------------------------------------------------------
Vector CNPC_AntlionGuardian::GetPhysicsHitPosition( CBaseEntity *pObject, CBaseEntity *pTarget, Vector *vecTrajectory, float *flClearDistance )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
inline bool CNPC_AntlionGuardian::CanStandAtPoint( const Vector &vecPos, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::CanStandAtShoveTarget( CBaseEntity *pShoveObject, CBaseEntity *pTarget, Vector *pOut )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CNPC_AntlionGuardian::GetNextShoveTarget( CBaseEntity *pLastEntity, AISightIter_t &iter )
{
...
//-----------------------------------------------------------------------------
CBaseEntity *CNPC_AntlionGuardian::FindPhysicsObjectTarget( const PhysicsObjectCriteria_t &criteria )
{
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::BuildScheduleTestBits( void )
{
	...
	if ( IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHASE_ENEMY ) )
	{
		SetCustomInterruptCondition( COND_ANTLIONGUARDIAN_PHYSICS_TARGET );
		SetCustomInterruptCondition( COND_ANTLIONGUARDIAN_CAN_SUMMON );
	}

	// Interrupt if we've been given a charge target
	if ( IsCurSchedule( SCHED_ANTLIONGUARDIAN_CHARGE ) == false )
	{
		SetCustomInterruptCondition( COND_ANTLIONGUARDIAN_HAS_CHARGE_TARGET );
	}
...
//			magnitude - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::ImpactShock( const Vector &origin, float radius, float magnitude, CBaseEntity *pIgnored )
{
...
// Input  : *pTarget - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::ChargeDamage( CBaseEntity *pTarget )
{
	if ( pTarget == NULL )
		return;
	...
	float flDamage = ( pPlayer == NULL ) ? 250 : sk_antlionguardian_dmg_charge.GetFloat();
	
	// If it's being held by the player, break that bond
	Pickup_ForcePlayerToDropThisObject( pTarget );

	// Calculate the physics force
	GuardianApplyChargeDamage(this, pTarget, flDamage);
}
...
// Input  : &inputdata - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputRagdoll( inputdata_t &inputdata )
{
	if ( IsAlive() == false )
		return;
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputEnablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputDisablePreferPhysicsAttack( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::SelectFailSchedule( int failedSchedule, int failedTask, AI_TaskFailureCode_t taskFailCode )
{
	// Figure out what to do next
	if ( failedSchedule == SCHED_ANTLIONGUARDIAN_CHASE_ENEMY && HasCondition( COND_ENEMY_UNREACHABLE ) )
		return SelectUnreachableSchedule();
...
// Output : int
//-----------------------------------------------------------------------------
int CNPC_AntlionGuardian::TranslateSchedule( int scheduleType )
{
	switch( scheduleType )
	{
	case SCHED_CHASE_ENEMY:
		return SCHED_ANTLIONGUARDIAN_CHASE_ENEMY;
		break;
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::StartSounds( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputEnableBark( inputdata_t &inputdata )
{
	m_bBarkEnabled = true;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputDisableBark( inputdata_t &inputdata )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::DeathSound( const CTakeDamageInfo &info )
{
	if (IsOnFire())
		return;
...
// Input  : &info - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::Event_Killed( const CTakeDamageInfo &info )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::CanBecomeRagdoll( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::BecomeRagdollOnClient( const Vector &force )
{
	if ( !CanBecomeRagdoll() ) 
		return false;
...
// Output :
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::OverrideMoveFacing( const AILocalMoveGoal_t &move, float flInterval )
{
	...
	else if ( GetEnemy() && IsCurSchedule( SCHED_ANTLIONGUARDIAN_CANT_ATTACK ) )
	{
	...
	else if ( GetEnemy() && GetNavigator()->GetMovementActivity() == ACT_RUN )
  	{
		...
		if ( ( UTIL_DistApprox( vecEnemyLKP, GetAbsOrigin() ) < 512 ) || IsCurSchedule( SCHED_ANTLIONGUARDIAN_PATROL_RUN ) )
		{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::IsHeavyDamage( const CTakeDamageInfo &info )
{
	// Struck by blast
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::IsLightDamage( const CTakeDamageInfo &info )
{
	return false;
}
...
// Input  : *pChild - 
//-----------------------------------------------------------------------------
void CNPC_AntlionGuardian::InputSummonedAntlionDied( inputdata_t &inputdata )
{
	m_iNumLiveAntlions--;
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::QueryHearSound( CSound *pSound )
{
...
//---------------------------------------------------------
bool CNPC_AntlionGuardian::CNavigator::GetStoppingPath( CAI_WaypointList *pClippedWaypoints )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CNPC_AntlionGuardian::RememberFailedPhysicsTarget( CBaseEntity *pTarget )
{
	// Already in the list?
...
//-----------------------------------------------------------------------------
void	CNPC_AntlionGuardian::PopulatePoseParameters( void )
{
...
//-----------------------------------------------------------------------------
unsigned char CNPC_AntlionGuardian::GetBleedingLevel( void ) const
{
...
AI_BEGIN_CUSTOM_NPC( npc_antlionguardian, CNPC_AntlionGuardian )
	...
	//Tasks
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_CHARGE )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_GET_PATH_TO_PHYSOBJECT )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_SHOVE_PHYSOBJECT )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_SUMMON )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_SET_FLINCH_ACTIVITY )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_GET_PATH_TO_CHARGE_POSITION )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_GET_PATH_TO_NEAREST_NODE )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_GET_CHASE_PATH_ENEMY_TOLERANCE )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_OPPORTUNITY_THROW )
	DECLARE_TASK( TASK_ANTLIONGUARDIAN_FIND_PHYSOBJECT )

	//Activities
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_SEARCH )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_PEEK_FLINCH )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_PEEK_ENTER )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_PEEK_EXIT )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_PEEK1 )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_BARK )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_PEEK_SIGHTED )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_START )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_CANCEL )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_RUN )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_CRASH )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_STOP )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_HIT )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_CHARGE_ANTICIPATION )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_SHOVE_PHYSOBJECT )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_FLINCH_LIGHT )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_UNBURROW )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_ROAR )
	DECLARE_ACTIVITY( ACT_GNTLIONGUARD_RUN_HURT )
	...
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_SHOVE_PHYSOBJECT )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_SHOVE )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_FOOTSTEP_LIGHT )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_FOOTSTEP_HEAVY )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_CHARGE_EARLYOUT )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_GROWL )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_BARK )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_PAIN )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_SQUEEZE )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_SCRATCH )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_GRUNT )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_BURROW_OUT )
	DECLARE_ANIMEVENT( AE_GNTLIONGUARD_VOICE_ROAR )

	DECLARE_CONDITION( COND_ANTLIONGUARDIAN_PHYSICS_TARGET )
	DECLARE_CONDITION( COND_ANTLIONGUARDIAN_PHYSICS_TARGET_INVALID )
	DECLARE_CONDITION( COND_ANTLIONGUARDIAN_HAS_CHARGE_TARGET )
	DECLARE_CONDITION( COND_ANTLIONGUARDIAN_CAN_SUMMON )
	DECLARE_CONDITION( COND_ANTLIONGUARDIAN_CAN_CHARGE )
	...
	(
		...
		"		TASK_STOP_MOVING						0"
		"		TASK_FACE_ENEMY							0"
		"		TASK_PLAY_SEQUENCE						ACTIVITY:ACT_GNTLIONGUARD_BARK"
		"		TASK_ANTLIONGUARDIAN_SUMMON				0"
		"		TASK_ANTLIONGUARDIAN_OPPORTUNITY_THROW		0"
		"	"
		"	Interrupts"
		"		COND_HEAVY_DAMAGE"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING					0"
		"		TASK_SET_FAIL_SCHEDULE				SCHEDULE:SCHED_ANTLIONGUARDIAN_CHASE_ENEMY"
		"		TASK_FACE_ENEMY						0"
		"		TASK_ANTLIONGUARDIAN_CHARGE			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	//==================================================
	// SCHED_ANTLIONGUARDIAN_CHARGE_SMASH
	//==================================================
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING			0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_GNTLIONGUARD_CHARGE_CRASH"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_HEAVY_DAMAGE"
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_ANTLIONGUARDIAN_CHASE_ENEMY"
		"		TASK_ANTLIONGUARDIAN_GET_PATH_TO_PHYSOBJECT	0"
		"		TASK_RUN_PATH								0"
		"		TASK_WAIT_FOR_MOVEMENT						0"
		"		TASK_FACE_ENEMY								0"
		"		TASK_ANTLIONGUARDIAN_SHOVE_PHYSOBJECT			0"
		""
		"	Interrupts"
		"		COND_TASK_FAILED"
		"		COND_ENEMY_DEAD"
	...
	( 
		...
		"	Tasks"
		"		TASK_SET_FAIL_SCHEDULE						SCHEDULE:SCHED_ANTLIONGUARDIAN_CANT_ATTACK"
		"		TASK_ANTLIONGUARDIAN_FIND_PHYSOBJECT			0"
		"		TASK_SET_SCHEDULE							SCHEDULE:SCHED_ANTLIONGUARDIAN_PHYSICS_ATTACK"
		""
		"	Interrupts"
		"		COND_ANTLIONGUARDIAN_PHYSICS_TARGET"
		"		COND_HEAVY_DAMAGE"
	)
	...
	(
		...
		"		TASK_ANTLIONGUARDIAN_SET_FLINCH_ACTIVITY	0"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_GNTLIONGUARD_UNBURROW"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_GNTLIONGUARD_CHARGE_CANCEL"
		""
		"	Interrupts"
	)
	...
	(
		...
		"	Tasks"
		"		TASK_ANTLIONGUARDIAN_GET_PATH_TO_CHARGE_POSITION	0"
		"		TASK_RUN_PATH									0"
		"		TASK_WAIT_FOR_MOVEMENT							0"
		"	"
		"	Interrupts"
	...
	(
		...
		"	Tasks"
		"		TASK_STOP_MOVING									0"
		"		TASK_SET_FAIL_SCHEDULE								SCHEDULE:SCHED_ANTLIONGUARDIAN_PATROL_RUN"
		"		TASK_ANTLIONGUARDIAN_GET_PATH_TO_NEAREST_NODE			500"
		"		TASK_RUN_PATH										0"
		"		TASK_WAIT_FOR_MOVEMENT								0"
		"		TASK_FACE_ENEMY										0"
		""
	...
	(
		...
		"		TASK_STOP_MOVING			0"
		"		TASK_FACE_ENEMY				0"
		"		TASK_PLAY_SEQUENCE			ACTIVITY:ACT_GNTLIONGUARD_ROAR"
		"	"
		"	Interrupts"
		"		COND_HEAVY_DAMAGE"
	)
